...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        // RESOLVIDO: Chamar o método SaveChanges do _context para salvar no Banco SQL
        ...
        // RESOLVIDO: Chamar o método UpsertEntity para salvar no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // RESOLVIDO: As propriedades estão completas.

        // RESOLVIDO: Chamar o método de Update do _context.Funcionarios para salvar no Banco SQL
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // RESOLVIDO: Chamar o método de Remove do _context.Funcionarios para salvar no Banco SQL
